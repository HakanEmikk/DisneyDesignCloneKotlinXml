package com.example.disneyclone.adapters
...
import com.example.disneyclone.databinding.ItemMovieCardBinding
...
class MovieAdapter : ListAdapter<Movie, MovieAdapter.MovieViewHolder>(MovieDiffCallback()) {
    ...
    class MovieViewHolder(private val binding: ItemMovieCardBinding) :
        ...
        fun bind(movie: Movie) {
            binding.moviePoster.setImageResource(movie.posterResId)
        }
    }
